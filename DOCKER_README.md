...
- [`v1`, `v1.12`, `v1.12.0`, `latest`](https://github.com/Der-Henning/tgtg/blob/v1.12.0/Dockerfile)
- [`v1-alpine`, `v1.12-alpine`, `v1.12.0-alpine`, `latest-alpine`](https://github.com/Der-Henning/tgtg/blob/1.12.0/Dockerfile.alpine)
