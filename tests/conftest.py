...
def tgtg_item():
    return {
        ...
        "item": {
            "average_overall_rating": {"average_overall_rating": 3.3333333333333335, "month_count": 6, "rating_count": 162},
            "badges": [
                {
            ...
            "price_excluding_taxes": {"code": "EUR", "decimals": 2, "minor_units": 280},
            "price_including_taxes": {"code": "EUR", "decimals": 2, "minor_units": 300},
            "sales_taxes": [{"tax_description": "USt.", "tax_percentage": 7.0}],
            "show_sales_taxes": False,
            "tax_amount": {"code": "EUR", "decimals": 2, "minor_units": 20},
            "taxation_policy": "PRICE_INCLUDES_TAXES",
            "value_excluding_taxes": {"code": "EUR", "decimals": 2, "minor_units": 841},
            "value_including_taxes": {"code": "EUR", "decimals": 2, "minor_units": 900},
        },
        "item_type": "MAGIC_BAG",
        "items_available": 3,
        "new_item": False,
        "pickup_interval": {"end": "2022-12-30T19:30:00Z", "start": "2022-12-30T19:00:00Z"},
        "pickup_location": {
            "address": {
