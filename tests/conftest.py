...
def tgtg_item():
    return {'item': {'item_id': '774625',
                     ...
                     'item_category': 'MEAL',
                     'buffet': False,
                     'badges': [{'badge_type': 'SERVICE_RATING_SCORE',
                                 'rating_group': 'LIKED',
                                 'percentage': 85,
                                 'user_count': 162,
                                 'month_count': 5}],
                     'positive_rating_reasons': ['POSITIVE_FEEDBACK_DELICIOUS_FOOD',
                     ...
                     'average_overall_rating': {'average_overall_rating': 3.3333333333333335,
                                                'rating_count': 162,
                                                'month_count': 6},
                     'favorite_count': 0},
            'store': {'store_id': '758373',
                      'store_name': 'Chutney Indian Food',
                      'branch': 'Hamburg – Europapassage 2.OG',
                      'description': '',
                      'tax_identifier': 'DE252292855',
                      'website': '',
                      'store_location': {'address': {'country': {'iso_code': 'DE',
                                                                 'name': 'Germany'},
            ...
            'pickup_interval': {'start': '2022-12-30T19:00:00Z',
                                'end': '2022-12-30T19:30:00Z'},
            'pickup_location': {'address': {'country': {'iso_code': 'DE',
                                                        'name': 'Germany'},
                                            'address_line': 'Ballindamm 40, 20095 Hamburg, Deutschland',
                                            'city': '',
                                            'postal_code': ''},
